...
final readonly class ValueAddedTaxService
{
    ...
    public function calculate(Money $money, string $countryCode): ValueAddedTaxInclusivePrice
    {
        ...
        return ValueAddedTaxInclusivePrice::from([
            ...
            'grossValue' => $money,
            'taxedValue' => $taxedValue = $money->multipliedBy($vatPercentage)->dividedBy(100),
            'totalValue' => $money->plus($taxedValue),
        ]);
    }
}
